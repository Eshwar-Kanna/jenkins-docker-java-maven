        ...
        stage('Deploy webAPP in Prod Env') {
            steps {
               ...
               sshagent(['QA_ENV_SSH_CRED']) {
                    ...
                    sh "ssh  ec2-user@13.232.250.244 sudo kubectl  create    deployment myjavawebapp  --image=eshwar29/javaweb:${BUILD_TAG}"
                    sh "ssh ec2-user@13.232.250.244 sudo wget https://raw.githubusercontent.com/Eshwar-Kanna/jenkins-docker-java-maven/master/webappsvc.yml"
